...
'''
相比MuGo_board增加的内容：
1.Group中的stones和liberties变成了frozenset
2.增加了replay_position生成器，可以重演历史
3.position增加了board_deltas变量，用于存储每一步的变化
4.position增加了all_legal_moves方法，返回所有合法的move的mask
5.position增加了is_game_over方法，可以判断游戏是否结束
